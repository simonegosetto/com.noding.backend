...
// are performed on the master serverExpress and read operations are executed against
...
// master serverExpress for all the subsequent requests (either reads and writes).
//
// This example must be executed using the second Redis serverExpress configured as the
