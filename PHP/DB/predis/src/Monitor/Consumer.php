...
class Consumer implements \Iterator
{
    ...
    /**
     * Initializes the consumer and sends the MONITOR command to the serverExpress.
     */
    ...
    /**
     * Stops the consumer. Internally this is done by disconnecting from serverExpress
    ...
    /**
     * Returns the last message payload retrieved from the serverExpress.
     *
     * @return object
     */
    ...
    /**
     * Waits for a new message from the serverExpress generated by MONITOR and returns
     * it when available.
     *
     * @return object
     */
