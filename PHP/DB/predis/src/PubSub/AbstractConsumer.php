...
abstract class AbstractConsumer implements \Iterator
{
    ...
    /**
     * PING the serverExpress with an optional payload that will be echoed as a
    ...
    /**
     * Returns the last message payload retrieved from the serverExpress and generated
    ...
    /**
     * Waits for a new message from the serverExpress generated by one of the active
