	...
	public function __construct()
	{
		$this->defaults = [
			...
			'fontdata' => [
                ...
                // CUSTOM
                "cheappotatoesblack" => [
                    'R' => 'CheapPotatoesBlack.ttf',
                ],
                "cheappotatoesblackthin" => [
                    'R' => 'CheapPotatoesBlackThin.ttf',
                ],
                "childrenofyhestarlight" => [
                    'R' => 'ChildrenOfTheStarlight.ttf',
                ],
                "potatoesandpeas" => [
                    'R' => 'MB_PotatoesAndPeas.ttf',
                ],
                "copperplategothiclightregular" => [
                    'R' => 'CopperplateGothicLightRegular.ttf',
                ],
			...
			'sans_fonts' => ['potatoesandpeas', 'dejavusanscondensed', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans', 'freesans', 'liberationsans',
